...
import { Menu, Search, ScanLine, Sun, Moon, Bell, MapPin, Package, Ticket, X } from 'lucide-react'
  ...
  return (
    <header className="topbar">
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, flex: 1, minWidth: 0 }}>
        ...
        <div className="search-bar" ref={wrapperRef} style={{ position: 'relative', flex: 1, maxWidth: 480 }}>
          <Search size={16} />
          <input
            type="text"
            id="global-search"
